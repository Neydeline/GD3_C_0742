...
import com.example.gd3_c_0742.entity.Dosen
...
class FragmentDosen : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // tidak mengubah size recylcer vie jika terdapat item ditambahkan atau dikurangkan
        rvDosen.setHasFixedSize(true)

        // set adapter dari recyler view
